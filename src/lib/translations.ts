...
export const translations = {
  en: {
    ...
    "harvestMarketplaceDesc": "Connect with buyers and optimize produce sales through our integrated marketplace",
    "recyclersMarketplaceDesc": "Find the best recycling partners for maximum value from your waste materials",
  ...
  hi: {
    ...
    "harvestMarketplaceDesc": "हमारे एकीकृत मार्केटप्लेस के माध्यम से खरीदारों से जुड़ें और उत्पाद बिक्री को अनुकूलित करें",
    "recyclersMarketplaceDesc": "अपनी अपशिष्ट सामग्री से अधिकतम मूल्य के लिए सर्वोत्तम रीसाइक्लिंग भागीदार खोजें",
  ...
  bn: {
    ...
    "harvestMarketplace": "হার্ভেস্ট মার্কেটপ্লেস",
    "harvestMarketplaceDesc": "আমাদের সংযুক্ত মার্কেটপ্লেসের মাধ্যমে ক্রেতাদের সাথে যুক্ত হন এবং পণ্য বিক্রয় অনুকূলিত করুন",
    "recyclersMarketplaceDesc": "আপনার বর্জ্য পদার্থ থেকে সর্বোচ্চ মূল্যের জন্য সেরা পুনর্ব্যবহারকারী অংশীদার খুঁজুন",
    "learnMore": "আরও জানুন",
