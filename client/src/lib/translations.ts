...
export const translations = {
  en: {
    ...
    "connectVinyasaSorter": "Connect Vinyasa Sorter Machine",
    "disconnectVinyasaSorter": "Disconnect Vinyasa Sorter Machine",
    "vinyasaSorterMachine": "Vinyasa Sorter Machine",
    "vinyasaAiLoaded": "Vinyasa AI Loaded",
    "loadingAiModel": "Loading AI Model...",
    "cameraStreamInactive": "Camera Stream Inactive",
    "initializingVinyasaAi": "Initializing Vinyasa-AI model...",
    "clickStartStream": "Click \"Start Stream\" to begin waste detection",
    "liveAiDetectionActive": "Live AI Detection Active",
    ...
    "compostRecyclers": "Compost Recyclers",
    "biogasPlants": "Biogas Plants",
    "plasticRecyclers": "Plastic Recyclers",
    "ewasteRecyclers": "eWaste Recyclers",
    "medicalWasteRecyclers": "Medical Waste Recyclers",
    "metalRecyclers": "Metal Recyclers",
    "totalItemsDetected": "Total Items Detected",
  ...
  hi: {
    ...
    "resetCounts": "काउंट्स रीसेट करें",
    "connectVinyasaSorter": "विन्यास सॉर्टर मशीन कनेक्ट करें",
    "disconnectVinyasaSorter": "विन्यास सॉर्टर मशीन डिस्कनेक्ट करें",
    "vinyasaSorterMachine": "विन्यास सॉर्टर मशीन",
    "vinyasaAiLoaded": "विन्यास AI लोड हो गया",
    "loadingAiModel": "AI मॉडल लोड हो रहा है...",
    "cameraStreamInactive": "कैमरा स्ट्रीम निष्क्रिय",
    "initializingVinyasaAi": "विन्यास-AI मॉडल प्रारंभ हो रहा है...",
    "clickStartStream": "वेस्ट डिटेक्शन शुरू करने के लिए \"स्ट्रीम शुरू करें\" पर क्लिक करें",
    "liveAiDetectionActive": "लाइव AI डिटेक्शन सक्रिय",
    "detectionStopped": "डिटेक्शन बंद",
    ...
    "count": "गिनती",
    "percentage": "प्रतिशत",
    "recyclerType": "रीसाइक्लर प्रकार",
    "dryWaste": "सूखा कचरा",
    "wetWaste": "गीला कचरा",
    "plasticWaste": "प्लास्टिक कचरा",
    "electronicWaste": "इलेक्ट्रॉनिक कचरा",
    "medicalWaste": "मेडिकल कचरा",
    "metalWaste": "धातु कचरा",
    "compostRecyclers": "कंपोस्ट रीसाइक्लर्स",
    "biogasPlants": "बायोगैस प्लांट्स",
    "plasticRecyclers": "प्लास्टिक रीसाइक्लर्स",
    "ewasteRecyclers": "ई-वेस्ट रीसाइक्लर्स",
    "medicalWasteRecyclers": "मेडिकल वेस्ट रीसाइक्लर्स",
    "metalRecyclers": "मेटल रीसाइक्लर्स",
    "totalItemsDetected": "कुल आइटम पता लगाए गए",
    "detectionRate": "पता लगाने की दर",
    "aiAccuracy": "AI सटीकता",
    "itemsPerSec": "आइटम/सेकंड"
  },
  ...
  bn: {
    ...
    // Live Waste Sorting Page
    "startStream": "স্ট্রিম শুরু করুন",
    "stopStream": "স্ট্রিম বন্ধ করুন",
    "resetCounts": "কাউন্ট রিসেট করুন",
    "connectVinyasaSorter": "ভিন্যাস সর্টার মেশিন সংযুক্ত করুন",
    "disconnectVinyasaSorter": "ভিন্যাস সর্টার মেশিন সংযোগ বিচ্ছিন্ন করুন",
    "vinyasaSorterMachine": "ভিন্যাস সর্টার মেশিন",
    "vinyasaAiLoaded": "ভিন্যাস AI লোড হয়েছে",
    "loadingAiModel": "AI মডেল লোড হচ্ছে...",
    "cameraStreamInactive": "ক্যামেরা স্ট্রিম নিষ্ক্রিয়",
    "initializingVinyasaAi": "ভিন্যাস-AI মডেল শুরু হচ্ছে...",
    "clickStartStream": "বর্জ্য সনাক্তকরণ শুরু করতে \"স্ট্রিম শুরু করুন\" ক্লিক করুন",
    "liveAiDetectionActive": "লাইভ AI সনাক্তকরণ সক্রিয়",
    "detectionStopped": "সনাক্তকরণ বন্ধ",
    "loading": "লোড হচ্ছে...",
    "connected": "সংযুক্ত",
    ...
    "count": "গণনা",
    "percentage": "শতাংশ",
    "recyclerType": "রিসাইক্লার প্রকার",
    "dryWaste": "শুকনো বর্জ্য",
    "wetWaste": "ভেজা বর্জ্য",
    "plasticWaste": "প্লাস্টিক বর্জ্য",
    "electronicWaste": "ইলেকট্রনিক বর্জ্য",
    "medicalWaste": "চিকিৎসা বর্জ্য",
    "metalWaste": "ধাতব বর্জ্য",
    "compostRecyclers": "কম্পোস্ট রিসাইক্লার্স",
    "biogasPlants": "বায়োগ্যাস প্ল্যান্ট",
    "plasticRecyclers": "প্লাস্টিক রিসাইক্লার্স",
    "ewasteRecyclers": "ই-ওয়েস্ট রিসাইক্লার্স",
    "medicalWasteRecyclers": "মেডিকেল ওয়েস্ট রিসাইক্লার্স",
    "metalRecyclers": "মেটাল রিসাইক্লার্স",
    "totalItemsDetected": "মোট আইটেম সনাক্ত",
    "detectionRate": "সনাক্তকরণের হার",
    "aiAccuracy": "AI নির্ভুলতা",
    "itemsPerSec": "আইটেম/সেকেন্ড"
  },
